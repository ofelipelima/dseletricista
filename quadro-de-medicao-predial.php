        ...
        <div class="tt-breadcrumbs-wrapper">
            <div class="container">
                <ul class="tt-breadcrumbs">
                    ...
                    <li><span>Quadro de medição para prédios e condomínios</span></li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-9">
                                    <div class="simple-text">
                                        ...
                                        <p class="lead-text">Somos especialistas em quadro de medição predial com mais de 15 anos de experiência!</p>
                                        <p class="lead-text">Precisa fazer instalação de quadro de medição? Ou a troca do quadro de medição? Envie sua mensagem pelo formulário abaixo ou mande sua mensagem no WhatsApp. Orçamento gratuito!</p>
                                        <p class="lead-text">Nossa equipe é formada por profissionais qualificados e comprometidos com a excelência. Cada projeto é conduzido em conformidade com as normas e regulamentações elétricas vigentes, garantindo que o seu lar seja um ambiente seguro e protegido. </p>
                                        <p>&nbsp;</p>
                                        <p>
                                            <div class="text-center">
                                                <a class="c-btn type-1 size-2 font-2 color-3" href="https://wa.me/5548998414008?text=Olá! Vim pelo site e gostaria de mais informações sobre quadro de medição predial" target="_blank" rel="nofollow noopener noreferrer"><span><i class="fa fa-whatsapp" aria-hidden="true"></i> Chame o eletricista agora pelo Whatsapp</span></a>
                                            </div>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <img src="img/service-detail/quadro-disjuntor-pred.jpg" height="205" width="270" alt="">
                                    <div class="empty-space marg-lg-b30"></div>
                                    <img src="img/service-detail/quadro-disjuntor-pred2.jpg" height="205" width="270" alt="">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form action="envia-contato.php" method="post" class="tt-shedule-form" >
                                        ...
                                        <div class="c-btn type-1 size-3 font-3 color-4">
                                            ...
                                            <input type="hidden" name="pagina" value="Página quadro medição predial">
                                        </div>

...
<head>
    ...
    <title>Política de Privacidade - DS Instalações Elétricas</title>

    <meta name="keywords" content="política de privacidade, lgpd, DS instalações elétricas" />
    <meta name="description" content="Política de Privacidade do site e tratamento de informações - LGPD">
</head>
<body>
    ...
    <div id="content-wrapper">
        ...
        <div class="tt-pagelabel background-block" style="background-image:url(img/breadcrumbs/breadcrumbs.jpg);">
            <div class="container">
                <h1 class="tt-pagelabel-title">Política de Privacidade</h1>
            </div>
        </div>
                ...
                <div class="bg-2">
                    <div class="tt-two-blocks">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="tt-block-title type-2 color-2 c-h3"><i class="fa fa-calendar" aria-hidden="true"></i><span>Entrar em contato</span></h3>
                                    <div class="empty-space marg-lg-b45 marg-md-b30"></div>
                                    <form action="envia-contato.php" method="post" class="tt-shedule-form" >
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <input class="c-input" type="text" placeholder="Nome" name="nome" required>
                                            </div>                              
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="c-input" type="text" placeholder="Telefone" name="telefone">
                                            </div>                                    
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <textarea maxlength="5000" data-msg-required="Insira uma mensagem." rows="4" class="form-control" placeholder="Mensagem" name="msg" id="message" required></textarea>
                                            </div>                                   
                                        </div>
                                        <div class="empty-space marg-lg-b10 marg-md-b10 marg-xs-b10"></div>
                                        <div class="c-btn type-1 size-3 font-3 color-4">
                                            <input type="submit" value="Enviar">
                                            <input type="hidden" name="envia" value="ok">
                                            <input type="hidden" name="pagina" value="Página padrão de energia">
                                        </div>

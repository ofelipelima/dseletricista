...
<head>
    ...
    <meta name="keywords" content="eletricista residencial, eletricista casa, eletricista infra, eletricista infraestrutura, infraestrutura elétrica" />
    <meta name="description" content="Infraestrutura elétrica para casas e residências em Florianópolis">
</head>
<body>
    ...
    <div id="content-wrapper">
        ...
        <div class="tt-pagelabel background-block" style="background-image:url(img/breadcrumbs/breadcrumbs.jpg);">
            <div class="container">
                <h1 class="tt-pagelabel-title">Infraestrutura elétrica</h1>
            </div>
        </div>
        ...
        <div class="tt-breadcrumbs-wrapper">
            <div class="container">
                <ul class="tt-breadcrumbs">
                    ...
                    <li><span>Infraestrutura elétrica</span></li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                    ...
                                    <div class="simple-text">
                                        ...
                                        <p>
                                            <div class="text-center">
                                                <a class="c-btn type-1 size-2 font-2 color-3" href="https://wa.me/5548998414008?text=Olá! Vim pelo site e gostaria de mais informações sobre infraestrutura elétrica" target="_blank" rel="nofollow noopener noreferrer"><span><i class="fa fa-whatsapp" aria-hidden="true"></i> Chame o eletricista agora pelo Whatsapp</span></a>
                                            </div>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <img src="img/service-detail/infra-eletrica.jpg" height="205" width="270" alt="">
                                    <div class="empty-space marg-lg-b30"></div>
                                    <img src="img/service-detail/infra-eletrica2.jpg" height="205" width="270" alt="">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form action="envia-contato.php" method="post" class="tt-shedule-form" >
                                        ...
                                        <div class="c-btn type-1 size-3 font-3 color-4">
                                            ...
                                            <input type="hidden" name="pagina" value="Página Infraestrutura elétrica residencial">
                                        </div>

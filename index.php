...
<body>
    ...
    <div id="content-wrapper">
        ...
        <div class="rev_slider_wrapper">
            <div class="rev_slider"  data-version="5.0">
                <ul>
                    ...
                    <li data-transition="parallaxvertical" data-ease="SlowMo.ease">
                        <img src="img/slider/disjuntor2.jpg" height="650" width="1920"  alt="">
                        ...
                        <div class="col-md-6">
                            ...
                            <form action="envia-contato.php" method="post" class="tt-shedule-form">
                                ...
                                <div class="c-btn type-1 size-3 font-3 color-4">
                                    ...
                                    <input type="hidden" name="pagina" value="Página Home">
                                </div>
        ...
        <div class="empty-space marg-lg-b40 marg-md-b40"></div>

        <!-- TT-SERVICE-4 -->
        <div class="container">
            <div class="empty-space marg-lg-b80 marg-md-b60"></div>
            <h3 class="tt-block-title c-h3">Nossos serviços</h3>
        ...
        <!-- TT-SERVICE -->
        <div class="background-block tt-overlay" style="background-image:url(img/bg/bg_2.jpg);">
            <div class="container">
                <div class="empty-space marg-lg-b75 marg-md-b60"></div>
                <h3 class="tt-block-title color-2 c-h3">Serviços em destaque</h3>
                <div class="empty-space marg-lg-b50 marg-md-b30"></div>
                <div class="row">
                    <div class="col-sm-4">
        ...
        <div class="bg-1">
            <div class="container">
                <div class="empty-space marg-lg-b80 marg-md-b60"></div>
                <h3 class="tt-block-title c-h3">Por que nos escolher</h3>
                <div class="empty-space marg-lg-b65 marg-md-b50"></div>

                <div class="row">
                    <div class="col-sm-3">
                        <div class="tt-service-5">
                        ...
                        <div class="empty-space marg-xs-b40"></div>
                    </div>
                    <div class="col-sm-3">
                        <div class="tt-service-5">
                            <div class="tt-service-5-img">
                ...
                <div class="empty-space marg-lg-b115 marg-md-b60"></div>

...
<head>
    ...
    <title>Melhoria de carga elétrica - DS Instalações Elétricas</title>

    <meta name="keywords" content="melhoria de carga elétrica residencial, carga elétrica casa, eletricista carga elétrica, melhoria de carga elétrica" />
    <meta name="description" content="Melhoria de carga elétrica para casas e residências em Florianópolis">
</head>
<body>
    ...
    <div id="content-wrapper">
        ...
        <div class="tt-pagelabel background-block" style="background-image:url(img/breadcrumbs/breadcrumbs.jpg);">
            <div class="container">
                <h1 class="tt-pagelabel-title">Melhoria de carga elétrica</h1>
            </div>
        </div>
        ...
        <div class="tt-breadcrumbs-wrapper">
            <div class="container">
                <ul class="tt-breadcrumbs">
                    ...
                    <li><span>Melhoria de carga elétrica</span></li>
                </ul>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-9">
                                    <div class="simple-text">
                                        ...
                                        <p class="lead-text">Somos especialistas em melhoria de carga elétrica (ou fator de carga elétrica) residencial com mais de 15 anos de experiência!</p>
                                        <p class="lead-text">Envie sua mensagem pelo formulário abaixo ou mande sua mensagem no WhatsApp. Orçamento gratuito!</p>
                                        <p class="lead-text">Meu compromisso é fornecer serviços de alta qualidade, baseados em práticas seguras e conformidade com as normas elétricas. Utilizo materiais e técnicas mais inovadoras para garantir resultados duradouros e satisfação do cliente.</p>
                                        <p>&nbsp;</p>
                                        <p>
                                            <div class="text-center">
                                                <a class="c-btn type-1 size-2 font-2 color-3" href="https://wa.me/5548998414008?text=Olá! Vim pelo site e gostaria de mais informações sobre melhoria de carga elétrica" target="_blank" rel="nofollow noopener noreferrer"><span><i class="fa fa-whatsapp" aria-hidden="true"></i> Chame o eletricista agora pelo Whatsapp</span></a>
                                            </div>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <img src="img/service-detail/melhoria_eletrica.jpg" height="205" width="270" alt="">
                                    <div class="empty-space marg-lg-b30"></div>
                                    <img src="img/service-detail/melhoria_eletrica2.jpg" height="205" width="270" alt="">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form action="envia-contato.php" method="post" class="tt-shedule-form" >
                                        ...
                                        <div class="c-btn type-1 size-3 font-3 color-4">
                                            ...
                                            <input type="hidden" name="pagina" value="Página melhoria elétrica residencial">
                                        </div>
